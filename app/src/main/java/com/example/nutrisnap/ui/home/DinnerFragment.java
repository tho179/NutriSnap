...
public class DinnerFragment extends BaseMealFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_dinner_detail, container, false);
    ...
    private void addNewFoodItem(String name, int kcal, Uri imageUri) {
        ...
        Toast.makeText(getContext(), "Added to Dinner", Toast.LENGTH_SHORT).show();
    }
}